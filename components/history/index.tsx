          ...
          {dataSource.length > 0 ? (
            ...
            >
              {dataSource.map((item, idx) => (
                <div
                  key={item.id}
                  className="border-stroke-light bg-surface-300 hover:border-stroke-strong relative mb-4 flex break-inside-avoid flex-col space-y-4 overflow-hidden rounded-xl border"
                >
