...
import { BlogPostStateLoader } from "@/app/[locale]/(marketing)/(blog)/BlogPostStateLoader";
import { BlogReactions } from "@/app/[locale]/(marketing)/(blog)/BlogReactions";
import {
  CalendarIcon,
  CursorClickIcon,
  HourglassIcon,
...
export function BlogPostPage({
  ...
  return (
    <Container className="mt-8 mb-16 lg:mt-20">
